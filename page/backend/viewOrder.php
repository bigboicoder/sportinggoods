...
<main class="main-content">
    ...
    <div class="breadcrumbs">
        <a href="/page/backend/dashboard.php">Dashboard</a> &gt; <a href="/page/backend/orders.php">Orders</a> &gt; <span>View
            Order</span>
    </div>
        ...
        <div class="order-container">
            <div class="container-heading">
                ...
                <div class="order-heading-button" style="width:15%;">
                    <button class="button-blue" data-get="/page/backend/updateOrder.php?id=<?= $orderDetail->order_id ?>">Edit Order</button>
                </div>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($orderItemDetail as $productList): ?>
                            <tr>
                                ...
                                <td>Plants</td>
                                <td>RM<?= $productList->price ?></td>
                                <td><?= $productList->quantity ?></td>
                                <td>RM<?= $productList->subtotal ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
            ...
            <div class="container-order-footer">
                <div class="payment-method">
                    ...
                    <p>Order Status</p>
                    <select class="default-select" disabled>
                        <?php
                        $statuses = ['Pending', 'Processing', 'Completed', 'Cancel'];
                        foreach ($statuses as $status): ?>
                            <option <?= $orderDetail->order_status === $status ? 'selected' : '' ?>>
                                <?= $status ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
