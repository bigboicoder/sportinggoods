...
$query = "SELECT * FROM Users WHERE user_role = 'Admin' AND is_delete = 0";
$params = [];
...
<main class="main-content">
    <div class="breadcrumbs">
        <a href="/page/backend/dashboard.php">Dashboard</a> &gt; <span>Admin</span>
    </div>
    <div class="page-header">
        <h1>Admin</h1>
        <div class="button-add">
            <a href="/page/backend/addAdmin.php" class="button-normal">Add Admin</a>
        </div>
    </div>
    ...
    <form>
        <div class="filter-container">
            <div class="filters">
                ...
                <?= html_text('id', 'class="filter1" placeholder="Admin ID"') ?>
            ...
            <div class="filter-button">
                ...
                <div>
                    <a href="admin.php" class="button-grey">Reset</a>
                </div>
            </div>
        </div>
    </form>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <button data-get="/page/backend/viewAdmin.php?id=<?= $admin->user_id ?>">View
                                        Admin</button>
                                    <button data-get="/page/backend/updateAdmin.php?id=<?= $admin->user_id ?>">Update
                                        Admin</button>
