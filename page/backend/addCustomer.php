...
if (is_post()) {
    ...
    if (!$_err) {
        ...
        VALUES(?, ?, ?, ?, ?, ?, SHA1(?), ?)');
        $stm->execute([$name, $username, $fileName, $email, "User", $contactNum, $password, $status]);
...
<main class="main-content">
    ...
    <div class="breadcrumbs">
        <a href="/page/backend/dashboard.php">Dashboard</a> &gt; <a href="/page/backend/customers.php">Customers</a> &gt; <span>Add
            Customer</span>
    </div>
