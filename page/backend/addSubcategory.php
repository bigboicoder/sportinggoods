...
<main class="main-content">
    ...
    <div class="breadcrumbs">
        <a href="/page/backend/dashboard.php">Dashboard</a> &gt; <a href="/page/backend/subcategory.php">Subcategory</a> &gt; <span>Add Subcategory</span>
    </div>
    ...
    <form method="post" action="uploadSubCategory.php">
