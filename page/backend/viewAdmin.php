...
<main class="main-content">
    ...
    <div class="breadcrumbs">
        <a href="/page/backend/dashboard.php">Dashboard</a> &gt; <a href="/page/backend/admin.php">Admin</a> &gt; <span>View
            Admin</span>
    </div>
    ...
    <form>
        <div class="detail-container">
            ...
            <div class="row-input-container">
                ...
                <div class="row-input">
                    <img src="/uploads/profile/<?= $admin->user_photo ?>" style="width:150px;height:150px;border:1px solid #ced4da;padding:5px;">
                </div>
            </div>
            <div class="row-input-container">
            ...
            <div class="form-submit-button">
                <button data-get="/page/backend/updateAdmin.php?id=<?= $admin->user_id ?>" class="button-blue">Update Admin</button>
            </div>
        </div>
    </form>
</main>
